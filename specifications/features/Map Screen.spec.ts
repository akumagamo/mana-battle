...
describe("Map Screen", () => {
    describe("Map Creation", () => {
        ...
        test("When I am in in the Map Screen", assertCurrentScreen)
        test("Then I have nothing selected", assertNothingSelected)
        ...
        test("Then I should see that the game is paused", assertGameIsUnpaused)
    })
