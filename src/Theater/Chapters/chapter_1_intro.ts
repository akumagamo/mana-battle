...
const priest = makeUnit('mage', 'priest', 1, {});
...
export default (unit: Unit): SceneConfig => ({
  ...
  steps: [
    ...
    },
    {
      ...
      id: priest.id,
      question: `You find a magic scroll capable of shocking your enemies. What you do with it?.`,
      options: [
        { answer: 'I keep it for myself', value: 0.5 },
        { answer: 'I will study it.', value: 0 },
        { answer: 'I will sell it', value: 1 },
      ],
    },
    {
      type: 'QUESTION',
      ...
      options: [
        { answer: 'They are wise and know what is the best for me.', value: 0 },
        { answer: 'I try to listen and understand their argments.', value: 1 },
